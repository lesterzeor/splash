    ...
    return (
      <div className="spaceContainer">
        ...
        <div id="title">
          ...
          <h2 className="mainHeader">ESPIRE</h2>
          <h6 className="subHeader">New Age Digital Marketing</h6>
        <button style={styles.btn}><a style={{color:"black",height:"100%",padding:"10px"}} href="https://influence.espireads.com/signup">Influencer</a></button>
      <button style={styles.btn}><a style={{color:"black",height:"100%",padding:"10px"}} href="https://influence.espireads.com/advertiser_signup">Advertiser</a></button>
        </div>
      </div>
    );
  }
